...
namespace Activiti.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskActionRequest :  IEquatable<TaskActionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskActionRequest" /> class.
        /// </summary>
        /// <param name="Action">Action.</param>
        /// <param name="Assignee">Assignee.</param>
        /// <param name="Variables">Variables.</param>
        /// <param name="TransientVariables">TransientVariables.</param>
        public TaskActionRequest(string Action = default(string), string Assignee = default(string), List<RestVariable> Variables = default(List<RestVariable>), List<RestVariable> TransientVariables = default(List<RestVariable>))
        {
            this.Action = Action;
        ...
        {
            return this.Equals(input as TaskActionRequest);
        }

        /// <summary>
        /// Returns true if TaskActionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskActionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskActionRequest input)
        {
            if (input == null)
                return false;
