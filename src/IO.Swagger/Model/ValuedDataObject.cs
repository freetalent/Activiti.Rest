...
namespace Activiti.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ValuedDataObject :  IEquatable<ValuedDataObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValuedDataObject" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ValuedDataObject);
        }

        /// <summary>
        /// Returns true if ValuedDataObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ValuedDataObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValuedDataObject input)
        {
            if (input == null)
                return false;
