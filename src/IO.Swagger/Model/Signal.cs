...
namespace Activiti.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Signal :  IEquatable<Signal>, IValidatableObject
    {
        /// <summary>
