...
namespace Activiti.Rest.Model
{
    ...
    public partial class Pool :  IEquatable<Pool>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets ProcessRef
        /// </summary>
        [DataMember(Name="processRef", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProcessRef: ").Append(ProcessRef).Append("\n");
        ...
        public bool Equals(Pool input)
        {
            ...
            return 
                ...
                (
                    this.ProcessRef == input.ProcessRef ||
                    (this.ProcessRef != null &&
                    this.ProcessRef.Equals(input.ProcessRef))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProcessRef != null)
                    hashCode = hashCode * 59 + this.ProcessRef.GetHashCode();
