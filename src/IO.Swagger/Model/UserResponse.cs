...
namespace Activiti.Rest.Model
{
    ...
    public partial class UserResponse :  IEquatable<UserResponse>, IValidatableObject
    {
        ...
        public UserResponse(string Id = default(string), string FirstName = default(string), string LastName = default(string), string Url = default(string), string Email = default(string), string PictureUrl = default(string), string Password = default(string))
        {
            this.Id = Id;
