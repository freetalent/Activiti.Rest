...
namespace Activiti.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Lane :  IEquatable<Lane>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="parentProcess", EmitDefaultValue=false)]
        public Process ParentProcess { get; set; }

        /// <summary>
        /// Gets or Sets FlowReferences
        /// </summary>
        [DataMember(Name="flowReferences", EmitDefaultValue=false)]
        public List<string> FlowReferences { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ParentProcess: ").Append(ParentProcess).Append("\n");
            sb.Append("  FlowReferences: ").Append(FlowReferences).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as Lane);
        }

        /// <summary>
        /// Returns true if Lane instances are equal
        /// </summary>
        /// <param name="input">Instance of Lane to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Lane input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ParentProcess == input.ParentProcess ||
                    (this.ParentProcess != null &&
                    this.ParentProcess.Equals(input.ParentProcess))
                ) && 
                (
                    this.FlowReferences == input.FlowReferences ||
                    this.FlowReferences != null &&
                    this.FlowReferences.SequenceEqual(input.FlowReferences)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentProcess != null)
                    hashCode = hashCode * 59 + this.ParentProcess.GetHashCode();
                if (this.FlowReferences != null)
                    hashCode = hashCode * 59 + this.FlowReferences.GetHashCode();
                return hashCode;
            }
        }
