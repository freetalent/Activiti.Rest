...
namespace Activiti.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseElement :  IEquatable<BaseElement>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BaseElement);
        }

        /// <summary>
        /// Returns true if BaseElement instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseElement input)
        {
            if (input == null)
                return false;
